...
class MultiAxisPlot(PlotItem):
    ...
    **kargs: optional
    ...
    def __init__(self, parent=None, axisItems=None, **kargs):
        ...
        self.vb.undoSignal.connect(self.undoEvent)
    ...
    def addStackedView(self, view):
        ...
        view.undoSignal.connect(self.undoEvent)
    ...
    def undoEvent(self, undo=True):
        for stackedView in self.stackedViews:
            if undo:
                scale, center, axis = stackedView.undoStack.pop()
                stackedView.redoStack.append((1 / scale, center, axis))
            else:
                scale, center, axis = stackedView.redoStack.pop()
                stackedView.undoStack.append((1 / scale, center, axis))
